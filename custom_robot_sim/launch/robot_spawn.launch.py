...
def generate_launch_description():
    ...
    xacro_file_path = "/home/thomas/ros2_ws/src/custom_robot_sim/urdf/robot_description.urdf.xacro"

    #Robot starting position and orientation
    robot_pos = ['0.0', '0.0', '0.08']
    robot_yaw = '0.0'
    ...
    load_robot_arm_controller = ExecuteProcess(
